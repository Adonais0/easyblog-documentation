...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-fuchsia-50/50 py-1 pl-1.5 pr-3 text-sm text-fuchsia-900 ring-1 ring-inset ring-fuchsia-500/20 dark:bg-fuchsia-500/5 dark:text-fuchsia-200 dark:ring-fuchsia-500/30">
